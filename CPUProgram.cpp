...
void CPUProgram :: ReadFile(const char filename[]){
    ...
    {
		while(getline(inputFile,line[totalSize]))
		{
...
int CPUProgram :: checkIfAStringIsANumber(const string str,const int size){
...
int CPUProgram :: stringToInteger(const string str, const int size){
...
int CPUProgram :: checkParameters (string sbstr1x1, string sbstr1x2, string sbstr1x3,
...
int CPUProgram :: checkForSyntaxErrors(){
